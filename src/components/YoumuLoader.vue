...
const tokenRef = ref('');
const buttonStatus = ref('Download Video');
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const cookie = await browser.storage.local.get(["hostname", "token"]);
...
<template>
    <div id="popup-content">
        ...
        <div id="download-container">
            ...
            <button id="download-button" @click="downloadVideo()">{{ buttonStatus }}</button>
        </div>
    </div>
</template>
